...
export class PageBackground {
    ...
    constructor() {
        // Finds any <img> added to the "backgroundImage" ENGRid section and sets it as the "--page-backgroundImage-url" CSS Custom Property
        if(this.pageBackground){
            ...
            if (this.pageBackground && pageBackgroundImgDataSrc) {
                if (ENGrid.debug) console.log("A background image set in the page was found with a data-src value, setting it as --page-backgroundImage-url", pageBackgroundImgDataSrc);
                ...
                if (ENGrid.debug) console.log("A background image set in the page was found with a src value, setting it as --page-backgroundImage-url", pageBackgroundImgSrc);
                ...
                if (ENGrid.debug) console.log("A background image set in the page was not found, any default image set in the theme on --page-backgroundImage-url will be used");
            }
        } else {
            if (ENGrid.debug) console.log("A background image set in the page was not found, any default image set in the theme on --page-backgroundImage-url will be used");
        }

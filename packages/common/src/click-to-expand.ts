            ...
            this.clickToExpandWrapper.forEach((element: HTMLElement) => {
                ...
                element.addEventListener("keydown", event => {
                    if ((event as KeyboardEvent).key === 'Enter') {
                        if (ENGrid.debug) console.log("A click-to-expand div had the 'Enter' key pressed on it");
                        element.classList.add("expanded");
                    } else if ((event as KeyboardEvent).key === ' ') {
                        if (ENGrid.debug) console.log("A click-to-expand div had the 'Spacebar' key pressed on it");
                        element.classList.add("expanded");

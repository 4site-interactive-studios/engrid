export class EventTickets {
  constructor() {
    ...
    for (const ticketCostElement of ticketCostElements) {
      const ticketAmountElement = ticketCostElement.getElementsByClassName("en__ticket__price")[0] as HTMLElement;
      const ticketCurrencyElement = ticketCostElement.getElementsByClassName("en__ticket__currency")[0] as HTMLElement;

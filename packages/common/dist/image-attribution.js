...
export class ImageAttribution {
    constructor() {
        ...
        this.imagesWithAttribution = document.querySelectorAll("div:not(.page-backgroundImage) [data-attribution-source]:not([data-attribution-hide-overlay])");
        this.imagesWithAttribution.forEach((element) => {
            ...
            if (imagesWithAttributionParent) {
                ...
                let imagesWithAttributionElement = element;

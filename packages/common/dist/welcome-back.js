...
export class WelcomeBack {
     ...
     */
    constructor() {
        this.logger = new EngridLogger("WelcomeBack", "white", "magenta", "👋");
    ...
    addWelcomeBack() {
      ...
      <span class="engrid-reset-welcome-back">Not you?</span>
        ...
        (_a = document
            .querySelector(".body-main")) === null || _a === void 0 ? void 0 : _a.insertAdjacentElement("afterbegin", welcomeBack);
    }
    resetWelcomeBack() {
    ...
    `);
        (_a = document
            .querySelector(".fast-personal-details")) === null || _a === void 0 ? void 0 : _a.insertAdjacentElement("beforebegin", personalDetailsSummary);
    }
    addEventListeners() {
        document

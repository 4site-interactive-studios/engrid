...
export class ClickToExpand {
    constructor() {
        this.logger = new EngridLogger("Click to Expand");
        ...
        if (this.clickToExpandWrapper.length) {
            this.clickToExpandWrapper.forEach((element) => {
                ...
                element.addEventListener("keydown", (event) => {
                    if (event.key === "Enter") {
                        this.logger.log("A click-to-expand div had the 'Enter' key pressed on it");
                        element.classList.add("expanded");
                    }
                    else if (event.key === " ") {
                        this.logger.log("A click-to-expand div had the 'Spacebar' key pressed on it");
                        element.classList.add("expanded");
